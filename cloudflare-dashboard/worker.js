 ...
 * 2. Paste this code (or copy to src/index.js in Wrangler project)
 * 3. Set the API_BASE environment variable
 * 4. Deploy
 * 
 * Environment Variables:
 * - API_BASE: Your Paperfly local server URL (default: http://127.0.0.1:3000)
 */

// Configuration - Set in Cloudflare Worker environment
const API_BASE = typeof API_BASE !== 'undefined' ? API_BASE : 'http://127.0.0.1:3000';
    ...
    async function fetchData() {
      try {
        ...
        document.getElementById('error').innerHTML = \`
          ...
          <small>Make sure your Paperfly server is running locally on http://127.0.0.1:3000 or update API_BASE if needed.</small>
        \`;
      }
    }
